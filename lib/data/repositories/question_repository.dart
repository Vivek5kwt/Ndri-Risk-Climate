  ...
  static List<QuestionModel> getQuestions() {
    return [
      ...
      QuestionModel(
        variableNumber: '34',
        questionText:
            'Presence of water or land-related conflicts (Yes=1/ No=0)',
        questionType: QuestionType.vulnerability,
      ...
      QuestionModel(
        variableNumber: '35',
        questionText:
            'Number of years of membership in SHG/FIGs/ FPOs/ CIGs',
        questionType: QuestionType.vulnerability,
        category: 'Social Capital',
      ),
      QuestionModel(
      ...
      QuestionModel(
        variableNumber: '44.1',
        questionText: 'Increasing temperature during summers',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Perception',
      ),
      QuestionModel(
        variableNumber: '44.2',
        questionText: 'Decreasing temperature during winters',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Perception',
      ),
      QuestionModel(
        variableNumber: '44.3',
        questionText: 'Prolonged summer',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Perception',
      ),
      QuestionModel(
        variableNumber: '44.4',
        questionText: 'Reduced span of winters',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Perception',
      ),
      QuestionModel(
        variableNumber: '44.5',
        questionText: 'Delay onset of monsoon',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Perception',
      ),
      QuestionModel(
        variableNumber: '44.6',
        questionText: 'Occurrence of heavy fog during winter season',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Perception',
      ),
      QuestionModel(
        variableNumber: '44.7',
        questionText: 'Unpredictable rainfalls',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Perception',
      ),
      QuestionModel(
        variableNumber: '44.8',
        questionText: 'Decline in precipitation',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Perception',
      ),
      QuestionModel(
        variableNumber: '44.9',
        questionText: 'Long dry spells and increased rate of drought',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Perception',
      ),
      QuestionModel(
        variableNumber: '44.10',
        questionText: 'Change in the season cycle during last 10-15 years',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Perception',
      ),
      QuestionModel(
        variableNumber: '44.11',
        questionText: 'Increased rate of heat waves',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Perception',
      ),
      QuestionModel(
        variableNumber: '44.12',
        questionText: 'Increased rate of cold waves',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Perception',
      ),
      QuestionModel(
        variableNumber: '44.13',
        questionText: 'Increased high intensity rainfall events',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Perception',
      ),
      QuestionModel(
        variableNumber: '44.14',
        questionText: 'Increased THI',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Perception',
      ),
      QuestionModel(
        variableNumber: '44.15',
        questionText: 'Increased events of hailstorm',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Perception',
      ),
      QuestionModel(
        variableNumber: '44.16',
        questionText: 'Increase in relative humidity',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Perception',
      ),
      QuestionModel(
        variableNumber: '45.1',
        questionText:
            'Agriculture and dairy farming are extremely vulnerable to Climate Change',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Awareness',
      ),
      QuestionModel(
        variableNumber: '45.2',
        questionText: 'Heat stress may reduce the fertility of livestock',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Awareness',
      ),
      QuestionModel(
        variableNumber: '45.3',
        questionText:
            'Increase in temperature and humidity is the cause behind declined milk production of dairy bovine',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Awareness',
      ),
      QuestionModel(
        variableNumber: '45.4',
        questionText:
            'Heat stress may cause the reduced feed intake of the livestock',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Awareness',
      ),
      QuestionModel(
        variableNumber: '45.5',
        questionText:
            'Climate Change is the cause of increased rate of temperature-related illness and vector borne diseases among livestock',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Awareness',
      ),
      QuestionModel(
        variableNumber: '45.6',
        questionText:
            'The type, frequency and intensity of extreme climatic events are expected to rise even with a slight change in the climate',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Awareness',
      ),
      QuestionModel(
        variableNumber: '45.7',
        questionText:
            'Changes in rainfall pattern are likely to lead to severe water shortage and/or flooding',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Awareness',
      ),
      QuestionModel(
        variableNumber: '46.1',
        questionText: 'Rearing resilience breeds of livestock',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Preparedness',
      ),
      QuestionModel(
        variableNumber: '46.2',
        questionText: 'Use of rubber mats',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Preparedness',
      ),
      QuestionModel(
        variableNumber: '46.3',
        questionText: 'Cropping climate resilience fodder variety',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Preparedness',
      ),
      QuestionModel(
        variableNumber: '46.4',
        questionText: 'Use of fans',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Preparedness',
      ),
      QuestionModel(
        variableNumber: '46.5',
        questionText:
            'Cultivation of climate resilient crop varieties (including fodder)',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Preparedness',
      ),
      QuestionModel(
        variableNumber: '46.6',
        questionText: 'Using of animal shade for heat stress management',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Preparedness',
      ),
      QuestionModel(
        variableNumber: '46.7',
        questionText:
            'Herd diversification (whether own different kinds of animals: cattle, buffaloes, goats, pigs, sheeps)',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Preparedness',
      ),
      QuestionModel(
        variableNumber: '46.8',
        questionText: 'Availability of adequate drinking water',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Preparedness',
      ),
      QuestionModel(
        variableNumber: '46.9',
        questionText: 'Deworming of livestock',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Preparedness',
      ),
      QuestionModel(
        variableNumber: '46.10',
        questionText: 'Follow vaccination schedule',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Preparedness',
      ),
      QuestionModel(
        variableNumber: '46.11',
        questionText: 'Adoption of integrated farming system',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Preparedness',
      ),
      QuestionModel(
        variableNumber: '46.12',
        questionText: 'Use of climatic agro-advisory services',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Preparedness',
      ),
      QuestionModel(
        variableNumber: '46.13',
        questionText: 'Use of early warning dissemination systems',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Preparedness',
      ),
      QuestionModel(
        variableNumber: '46.14',
        questionText: 'Feeding Jaggery',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Preparedness',
      ),
      QuestionModel(
        variableNumber: '46.15',
        questionText: 'Massage with mustard oil',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Preparedness',
      ),
      QuestionModel(
        variableNumber: '46.16',
        questionText: 'Livestock insurance',
        questionType: QuestionType.vulnerability,
        category: 'Climate - Preparedness',
      ),
    ];
